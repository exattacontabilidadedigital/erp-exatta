...
interface ClientesFornecedoresPaginationProps {
  currentPage: number;
  totalPages: number;
  itemsPerPage: number;
  totalItems: number;
...
export function ClientesFornecedoresPagination({
  currentPage,
  totalPages,
  itemsPerPage,
  totalItems,
  ...
  loading = false
}: ClientesFornecedoresPaginationProps) {
    ...
    <div className="flex flex-col sm:flex-row items-center justify-between gap-4 px-6 py-4 bg-white border-t border-gray-200">
      <div className="flex items-center space-x-2">
        <div className="text-sm text-gray-600">
          ...
          <span className="font-semibold text-gray-900">{totalItems}</span> clientes/fornecedores
        </div>
      </div>
