-- =========================================================
-- SQL PARA CRIAÇÃO DAS TABELAS DE CONCILIAÇÃO BANCÁRIA
...
CREATE TABLE IF NOT EXISTS public.transaction_matches (
  ...
  -- Foreign Keys
  CONSTRAINT fk_transaction_matches_session 
    FOREIGN KEY (reconciliation_session_id) 
    REFERENCES public.reconciliation_sessions(id) 
    ON DELETE CASCADE,
    
  CONSTRAINT fk_transaction_matches_bank_transaction 
    FOREIGN KEY (bank_transaction_id) 
    REFERENCES public.bank_transactions(id) 
    ON DELETE CASCADE,
    
  CONSTRAINT fk_transaction_matches_system_transaction 
    FOREIGN KEY (system_transaction_id) 
    REFERENCES public.lancamentos(id) 
    ON DELETE SET NULL,
    
  CONSTRAINT fk_transaction_matches_created_by 
...
CREATE TABLE IF NOT EXISTS public.matching_rules (
  ...
  -- Foreign Keys
  CONSTRAINT fk_matching_rules_empresa 
    FOREIGN KEY (empresa_id) 
    REFERENCES public.empresas(id) 
    ON DELETE CASCADE,
    
  CONSTRAINT fk_matching_rules_created_by 
    FOREIGN KEY (created_by) 
    REFERENCES public.usuarios(id)
);
...
CREATE INDEX IF NOT EXISTS idx_transaction_matches_session 
  ON public.transaction_matches(reconciliation_session_id);
